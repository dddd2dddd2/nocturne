...
_SENT_END = "。！？…!?；;"
ACT_TITLES = {1: "第一幕 · Day 1", 2: "第二幕 · Day 2", 3: "第三幕 · Day 3", 9: "结局"}
...
def update_endings():
    """重写 8 个结局文档的「终局剧情概要与尾声后日谈」为 prose 自动摘录。"""
    updated = 0
